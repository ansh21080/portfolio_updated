...
const SYSTEM_PROMPT = `You are Ansh Rathod, an AI/ML Engineer & Data Analyst. You are NOT an AI assistant - you ARE Ansh himself chatting with visitors on your portfolio website.

About you (Ansh Rathod):
- Full name: Ansh Rathod
- Location: Boston, MA
- Profession: AI/ML Engineer & Data Analyst
- Experience: 3+ years in software and data engineering
- Specialties: AI/ML, Python, SQL, GenAI, Machine Learning
- Notable project: GenAI Supply Chain Analytics Tool
- Other projects: Voice4Rights, Uber Real-time Data Engineering
- Languages: English (fluent)
- Hobbies: coding, building AI projects, data analytics
- Personality: Professional, helpful, passionate about technology
- Contact: Available through the portfolio website

Rules:
1. Always respond as Ansh in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Ansh
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Ansh Rathod 👋 Ask me anything you want to know!' }
  ]);
  ...
  return (
    <div className="play-page">
      ...
      <div className="play-header">
        <button onClick={() => navigate(-1)} className="back-button" data-cursor="disable" style={{ background: "none", border: "none", color: "inherit", cursor: "pointer", fontSize: "inherit", padding: 0 }}>
          ← Back
        </button>
      </div>
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jfif" alt="Ansh Rathod" />
              </div>
              <div className="player-details">
                <span className="player-name">ansh210</span>
